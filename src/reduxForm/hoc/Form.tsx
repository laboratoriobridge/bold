...
const defaultConfig: Partial<FormProps> = {
...
export function form(userConfig: FormProps) {
    return <WrapperComponentsProps extends object>(WrappedComponent: React.SFC<WrapperComponentsProps> | React.ComponentClass<WrapperComponentsProps>) => {
        const resultConfig: FormProps = (Object as any).assign({}, defaultConfig, userConfig)

        return class extends React.Component<ReduxUIProps<UIStateShape> & ExternalFormProps & WrapperComponentsProps> {
            render() {
                return (
                    <Form
                        {...resultConfig}
                        render={props => <WrappedComponent {...props as any} />}
                    />
                )
            }
        }
