...
storiesOf('Form|WizardForm', module)
  .addDecorator(withRouter())
  .add('default', () => {
    return (
      <WizardForm onSubmit={action('submit')} onSubmitSucceeded={action('submitSucceeded')}>
        <WizardStep render={renderStep1} validate={validateStep1} />
        <WizardStep render={renderStep2} />
        <WizardStep render={renderStep3} />
      </WizardForm>
    )
  })
