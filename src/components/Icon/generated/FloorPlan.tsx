...
const SvgFloorPlan = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width='1em' height='1em' viewBox='0 0 24 24' {...props}>
    <path clipRule='evenodd' d='M10.24 9a1 1 0 011 1v4a1 1 0 01-2 0v-4a1 1 0 011-1z' />
    <path
      clipRule='evenodd'
    ...
    />
    <path clipRule='evenodd' d='M10.298 2a1 1 0 011 1v3a1 1 0 11-2 0V3a1 1 0 011-1z' />
  </svg>
)
