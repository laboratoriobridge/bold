...
import { SeriesType, ChartSeries, AxisOptions } from './model'

describe('Chart Component with Outliers', () => {
  const xAxis: AxisOptions = { domain: { init: 0, end: 5, step: 1 } }
  const yAxis: AxisOptions = { domain: { init: 0, end: 100, step: 20 } }
