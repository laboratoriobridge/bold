...
import { createGridContext, Grid, GridContext, GridContextType } from './Grid'
...
export function Cell(props: CellProps) {
  ...
  const gridContext = useContext(GridContext) || createGridContext(Grid.defaultProps, useBreakpoint())
  const { classes, css } = useStyles(createStyles, props, gridContext)
...
export const createStyles = (
  ...
  { gap, gapCrossAxis, direction }: GridContextType
) => ({
  cell: {
