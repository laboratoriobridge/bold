...
function SideNav(props) {
  ...
  var transitionState = Object(_lib_hooks_useTransition__WEBPACK_IMPORTED_MODULE_5__["useTransition"])(open, 200);
...
var createStyles = function createStyles(theme, _ref, state) {
  ...
  return {
    wrapper: Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
      ...
      position: 'fixed',
      zIndex: 10,
      left: state === 'exited' && -SIDE_NAV_WIDTH || state === 'exiting' && 0 || state === 'entering' && -SIDE_NAV_WIDTH || state === 'exited' && -SIDE_NAV_WIDTH
    }),
    entering: Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, theme.breakpoints.down('md'), {}),
    nav: {
...
//# sourceMappingURL=_app.js.ad6fa918aa47577ff24e.hot-update.js.map