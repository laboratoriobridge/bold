...
If the number of pillboxes exceeds the area of the component, use a [Tag](/components/tag) to indicate the number of hiding selected items (ex.: [+3]).
...
<Demo src='pages/components/multi-select-search/MultiSelectSearch' />
