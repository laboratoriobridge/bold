...
![Color consistency on buttons: Same level of brightness](/static/image/color-consistency.png)
...
![Color contrast ratios](/static/image/color-contrast.png)
...
![Inverted gray scale](/static/image/color-darkui.png)
