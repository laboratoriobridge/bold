...
![Do/Don't: Use icons to indicate error states](/static/image/accessibility-color.svg)
...
![Do/Don't: Contrast test on tags and buttons](/static/image/accessibility-contrast.svg)
...
![Focus on button and checkbox](/static/image/accessibility-focus.svg)
...
![Disabled field and button](/static/image/accessibility-assistivetech.svg)
