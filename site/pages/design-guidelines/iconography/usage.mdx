...
![Icon Grid](/static/image/icn-grid.png)

## Canvas size, padding, and live area

The icon grid establishes clear rules for the consistent, but flexible, positioning of the graphic elements.

![Canvas size, padding and live area](/static/image/icn-canvas.png)
...
![Button size and Glyph](/static/image/icn-size.png)
...
![Canvas size, padding and live area](/static/image/icn-keyline.png)
...
![Icon examples](/static/image/icn-pixel.png)
