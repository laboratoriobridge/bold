...
<table>
  <tbody>
    <tr>
      ...
      <td>
        Utilizados para apresentar informações ao usuário. Esses cards podem conter CTA (call-to-action) como botões e
        links.
      </td>
    </tr>
    <tr>
      <th>Clicável</th>
      <td>
        Utilizados como itens de navegação, onde redirecionam o usuário para outra página. Neste tipo de card não é
