...
- Deve aparecer apenas uma notificação por vez e devem utilizar no máximo duas linhas para apresentar as mensagens.
...
- Evite apresentar mensagens com códigos técnicos de erro que não ajudem o usuário a resolver o problema.
- Apresente mensagens específicas para cada situação ao invés de utilizar mensagens padrão.
